...
public class PolicyHandler {
    ...
    @Autowired
    StockAdminRepository stockAdminRepository;
    ...
    public void wheneverDeliveryCompleted_DecreaseStock(
        ...
        // Sample Logic //
        StockAdmin.decreaseStock(event);
    }
    ...
    public void wheneverSnippingReturn_IncreaseStock(
        @Payload SnippingReturn snippingReturn
    ) {
        SnippingReturn event = snippingReturn;
        System.out.println(
            "\n\n##### listener IncreaseStock : " + snippingReturn + "\n\n"
        );

        // Sample Logic //
        StockAdmin.increaseStock(event);
    }
}
//>>> Clean Arch / Inbound Adaptor
